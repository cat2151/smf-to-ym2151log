    ...
    for i, track in enumerate(mid.tracks):
        ...
        for msg in track:
            ...
            if msg.type == "set_tempo":
                ...
                events.append({"type": "tempo", "ticks": absolute_time, "tempo_bpm": tempo_bpm})
            ...
            # Extract note off events (including note_on with velocity 0)
                ...
                events.append({"type": "note_off", "ticks": absolute_time, "channel": msg.channel, "note": msg.note})

            # Extract program change events
            elif msg.type == "program_change":
                events.append(
                    {"type": "program_change", "ticks": absolute_time, "channel": msg.channel, "program": msg.program}
                )

    return {"ticks_per_beat": ticks_per_beat, "tempo_bpm": tempo_bpm, "events": events}
